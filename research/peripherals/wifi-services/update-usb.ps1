...
if((Get-FileHash $boot).Hash -ne '44F91E637BB908A51608E315EB85201D91CB02AD8D34C5315337F88D25AB6CF9') { throw 'Unexpected previous EFI' }
...
$payload=Join-Path $root 'tcl-wifi-services'
...
$backup=Join-Path $root 'EFI\BOOT\BOOTAA64-wifi-probe.bak'
...
[ordered]@{Disk=$disks[0].Number;Root=$root;EFIHash=(Get-FileHash $boot).Hash;FilesVerified=$manifest.Count;Backup='EFI/BOOT/BOOTAA64-wifi-probe.bak'} | ConvertTo-Json -Compress
