...
if((Get-FileHash $boot).Hash -ne 'AA16C5B6058643E543746446FC7B608CADA89EA576A0A6DC90629CC8F22CA20A') { throw 'Unexpected previous EFI' }
...
$payload=Join-Path $root 'tcl-wifi-probe'
...
$backup=Join-Path $root 'EFI\BOOT\BOOTAA64-logging-v2.bak'
...
[ordered]@{Disk=$disks[0].Number;Root=$root;EFIHash=(Get-FileHash $boot).Hash;FilesVerified=$manifest.Count;Backup='EFI/BOOT/BOOTAA64-logging-v2.bak'} | ConvertTo-Json -Compress
