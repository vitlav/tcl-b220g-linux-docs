#!/usr/bin/env python3
"""Read whitelisted timing configuration; only writes bank selector FF."""
import ctypes as C
import json
import os
...
try:
    ...
    for bank, regs in [(0xd0, list(range(0x0d, 0x1b))),
                       (0xa8, list(range(0x05, 0x0f)) + [0x11, 0x12, 0x14, 0x15, 0x16, 0x2d])]:
        write(0xff, bank)
