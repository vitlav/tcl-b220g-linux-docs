...
single={'interrupt-parent','operating-points-v2','required-opps','qcom,bcm-voters',
 'nvmem-cells','memory-region','qcom,remoteproc','qcom,smem'}
edges=[];errors=[]
...
roots=['/soc@0/display-subsystem@ae00000','/soc@0/clock-controller@af00000','/soc@0/interconnect@1740000','/soc@0/geniqup@ac0000/i2c@a90000']
def active_path(p):
 while p:
