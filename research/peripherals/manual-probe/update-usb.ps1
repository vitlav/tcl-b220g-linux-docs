...
if((Get-FileHash $boot).Hash -ne '7DBF5A3DEB94546E4964313BE23B2D3A3507FB8490E084CC1F35A282E429C14E') { throw 'Unexpected previous EFI' }
...
$payload=Join-Path $root 'tcl-manual-probe'
...
$backup=Join-Path $root 'EFI\BOOT\BOOTAA64-core-isolation.bak'
...
[ordered]@{Disk=$disks[0].Number;Root=$root;EFIHash=(Get-FileHash $boot).Hash;FilesVerified=$manifest.Count;Backup='EFI/BOOT/BOOTAA64-core-isolation.bak'} | ConvertTo-Json -Compress
