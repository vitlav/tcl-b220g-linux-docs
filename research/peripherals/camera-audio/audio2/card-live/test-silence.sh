...
echo SILENCE_TEST
amixer -c 0 cset name='HPHL Volume' 0
amixer -c 0 cset name='HPHR Volume' 0
amixer -c 0 cset name='RX_RX0 Digital Volume' 0
amixer -c 0 cset name='RX_RX1 Digital Volume' 0
...
timeout 8 aplay -D hw:0,0 -t raw -f S16_LE -r 48000 -c 2 -d 3 /dev/zero > /var/tmp/tcl-audio2/card-silence-aplay.txt 2>&1 &
playpid=$!
sleep 1
cat /proc/asound/card0/pcm0p/sub0/status
cat /proc/asound/card0/pcm0p/sub0/hw_params
wait "$playpid"
cat /var/tmp/tcl-audio2/card-silence-aplay.txt
echo CARD_TEST_END
