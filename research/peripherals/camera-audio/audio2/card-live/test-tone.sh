...
timeout 10 aplay -D hw:0,0 -t raw -f S16_LE -r 48000 -c 2 -d 6 /var/tmp/tcl-audio2/quiet-tone-s16le.raw > /var/tmp/tcl-audio2/card-tone-aplay.txt 2>&1 &
playpid=$!
sleep 1
cat /proc/asound/card0/pcm0p/sub0/status
cat /proc/asound/card0/pcm0p/sub0/hw_params
wait "$playpid"
cat /var/tmp/tcl-audio2/card-tone-aplay.txt
echo CARD_TEST_END
