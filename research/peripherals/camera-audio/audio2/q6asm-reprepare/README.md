...
- [q6asm-prepare-stopped.patch](../../../../../patches/kernel/dt/patches/audio/q6asm-prepare-stopped.patch) — Q6ASM DAI: повторный prepare после STOPPED. Локальный патч; тесты повторного воспроизведения в отчёте.
