...
Самостоятельная серия из **58 патчей** к Linux stable **v7.2.4**, база `5015d0d945b3d3f2b038d2667880d5762f7d9437`. Включает ACPI-поддержку USB/Wi-Fi, дисплея/GPU и изменения аудиодрайверов. Серии DT и qc7 перед ней не требуются.
