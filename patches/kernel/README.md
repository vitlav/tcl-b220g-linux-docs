...
**Актуальный самостоятельный ACPI-набор:** [Linux 7.2.4 — 58 патчей, конфигурация и границы проверки](acpi/linux-7.2.4/README.md). Применяется к чистому v7.2.4 без qc7 и без других патчей из этого каталога. DT-комплект ведётся отдельно.
