...
Работа DT USB не подтверждает ACPI USB. Для загрузочного диагностического комплекта нужны фактическое обнаружение носителя и проверенная запись логов; shell и работа клавиатуры сами по себе этого не обеспечивают.
