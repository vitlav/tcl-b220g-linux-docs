...
**Проверено на оборудовании:** инициализация UFS, чтение GPT всех шести LUN, полное чтение каждого LUN при архивировании и проверка извлечённого содержимого по SHA256 выполнены в DT-запуске. ICE прошёл отдельную проверку инициализации и возможностей. В текущем ACPI-запуске UFS пока не виден: OEM HID `QCOM24A5:00` присутствует, но конфигурация ядра отключала `CONFIG_SCSI_UFSHCD`. Зашифрованное I/O, запись и восстановление накопителя не испытаны.
