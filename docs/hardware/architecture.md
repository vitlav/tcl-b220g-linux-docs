...
Схема разложена на вертикальные блоки по подсистемам. Повторяющиеся SC7180 и firmware обозначают одни и те же узлы; все связи исходной общей схемы сохранены.
