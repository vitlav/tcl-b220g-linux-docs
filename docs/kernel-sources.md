...
**Актуальный самостоятельный ACPI-набор:** [Linux 7.2.4 — 16 патчей, конфигурация и проверенные результаты](../patches/kernel/acpi/linux-7.2.4/README.md). Применяется к чистому v7.2.4 без qc7 и без других патчей из этого каталога. DT-комплект ведётся отдельно.
...
[Происхождение qc7 до изменений TCL](../research/qc7-provenance/README.md): 16 исходных коммитов TravMurav с авторами и diff, коммит адаптации к 6.18, проверенные копии патчей и контрольные суммы. Это описание происхождения базы; комплекты изменений TCL для DT и ACPI ведутся независимо.
