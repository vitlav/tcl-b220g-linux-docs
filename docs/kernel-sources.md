...
**Актуальный самостоятельный ACPI-набор:** [Linux 7.2.4 — 16 патчей, конфигурация и проверенные результаты](../patches/kernel/acpi/README.md). Применяется к чистому v7.2.4 без qc7 и без других патчей из этого каталога. DT-комплект ведётся отдельно.
