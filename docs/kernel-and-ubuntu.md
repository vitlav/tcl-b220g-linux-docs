...
## Исходники и конфигурации

[Карта исходников](kernel-sources.md) связывает сохранённые конфигурации, DT и отдельные модули. Она указывает границы применимости черновиков и препятствия независимой сборке.
