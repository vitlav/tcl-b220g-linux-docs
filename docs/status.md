...
Состояние поддержки: 2026-09-18. Таблица ниже сохраняет DT-эталон; отдельные ACPI-результаты явно подписаны. Полное сопоставление DT/ACPI и критерии готовности: [план поддержки](roadmap.md).
...
Текущая ACPI-система использует `7.2.4-tcl-acpi-display1+`. Её функциональные результаты не означают, что весь новый исходный комплект уже пересобран и повторно проверен: [серия и манифест](../patches/kernel/acpi/README.md).
